...
class GroupCard extends StatefulWidget {
  ...
  const GroupCard({super.key, required this.group, required this.refresh});
            ...
            children: [
              ...
              FutureBuilder<QuerySnapshot<Map<String, dynamic>>>(
                ...
                builder: (context, snap) {
                  if (!snap.hasData) {
                    return Padding(
                      padding: EdgeInsets.all(context.dimensions.values.s12),
                    ...
                    children: members.map((m) {
                      ...
                      return ListTile(
                        ...
                        trailing: IconButton(
                          ...
                          onPressed: () async {
                            final chosen = await showMessageDialog(context, '');
                ...
                children: [
                  ...
                  IconButton(
                    icon: Icon(
                      ...
                      color: isOwner ? colors.primary : colors.primary,
                    ),
